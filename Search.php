...
$records = mysql_num_rows($result);
			  ...
			  ?>
                ...
                <tr>
                  <td valign="middle"><div align="center"><img src="images/<?php echo $Image1;?>" alt="" width="300" height="200" border="3" /></div></td>
                  <td colspan="1" valign="top"><table width="100%" height="251" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td><span class="style9 style10">Car Status:</span></td>
                      <td><span class="style9 style10"><?php echo $Status ;?></span></td>
                    </tr>
