...
<div class="main">
 ...
 <input type="text" name="dat" pattern="[1-31]{2}" placeholder="Date Of Issue">&nbsp;&nbsp;<input type="text" name="month" pattern="0[1-9]|1[012]" placeholder="Month">&nbsp;&nbsp;<input type="text" name="year" pattern="[1980-2014]{4}" placeholder="year purchase" required/><br><br></td>
 </tr>
        <tr>
          <td height="32">  
...
<br><br></td>
         ...
         <tr>
          <td><label> Address :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name="address" id="txtAddress" cols="30" rows="2" required></textarea><br><br></td>
        </tr>
        <tr>
...
<input type="text" name="con"  pattern="[789][0-9]{9}" placeholder="Your Contact Number" required>
<br><br></td>
        </tr>
        <tr>
          <td height="34"><label>Alternate Number</label>
<input type="text" name="con1" placeholder="Other contact"><br><br></td>
        </tr>
